...
#o.call(grid.arrange,c(mapList, ncol = 3, top = "Nearest Neighbor Prediction Factors by Fishnet", fontsize=2))
...
# colnames(regVars)
# 
# write.csv(colNameTbl,"tablenames\\tablenames.csv", row.names = FALSE)
